...
export async function followingUser(userId: string, followingArray: string[] , otherUserId: string, otherUserFollowers: string[]) {
    ...
    const updateArrayDecrementedOldUser = [...otherUserFollowers, userId]
...
//Md - mongoDb and this case we need set user idMd in appwrite this step need for  connected two date base in one
export async  function updateCurrentIdUserMd(userId:string, updateIdFromMd: string) {
